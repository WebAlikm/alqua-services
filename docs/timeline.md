...
| Core build | Friday afternoon to evening | Working resident discovery flow |
| Data and evidence | Friday night | Sample listings, test cases, initial screenshots |
| Polish and deployment | Saturday morning | Responsive UI, run instructions, deployment |
| Validation | Saturday midday | User-flow testing, performance notes, evidence updates |
...
gantt
    ...
    IA-inspired planning docs                :active,  p3, 2026-06-26 14:00, 2h

    section Build
    Core listing data model                  :         b1, 2026-06-26 16:00, 2h
    Resident discovery UI                    :         b2, 2026-06-26 18:00, 4h
    Search, filters, and actions             :         b3, 2026-06-26 22:00, 3h

    section Evidence
    Sample listings and test cases           :         e1, 2026-06-27 01:00, 2h
    Screenshots and user-flow tests          :         e2, 2026-06-27 09:00, 2h
    Performance and deployment notes         :         e3, 2026-06-27 11:00, 2h
